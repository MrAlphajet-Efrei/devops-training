...
- [ ] **Task 5: Create PostgreSQL StatefulSet** (AC: 2, 3, 6)
  ...
  - [ ] Create `infra/k8s/base/init-sql-configmap.yaml` from `apps/api/db/init.sql` content
  - [ ] Mount init-sql ConfigMap at `/docker-entrypoint-initdb.d/` in the StatefulSet
